'''
Escreva um programa em Python que simule o calculo de notas de um aluno em 
diferenters diciplinas. O programa deve modular e utilizar estruturas
de controle e funções.

1. Requisitos do sistema 
- Função calcular_media(notas)
    - deve receber uma LISTA de notas como parâmetro
    - deve ter uma estrutura de repetição (for ou while) para percorrer a 1
...
- Função verificar_aprovacao(media, media_minima)
    ...
    - se a média for maior ou igual a média minima, retornar String " Aprovado!"
    - se a média for maior ou igual a 5.0 e  menor que a média minima, retornar String "Recuperação"
...
- Função principal main()
    ...
    - chamar a função verificar_ aprovação para obter o status do aluno
...
def main():
    ...
    - Lista com as diciplinas
    - média mínima pra aprovação 
    ...
    #percorrer a lista de displinas
